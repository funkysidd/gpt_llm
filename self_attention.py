...
class SelfAttention_Simple(torch.nn.Module):
    def __init__(self, input_feature_count:int, output_feature_count:int, W_queries:torch.tensor, W_keys:torch.tensor,
    ...
    def from_random_weights(self, input_feature_count:int, output_feature_count:int):
        return self(input_feature_count, output_feature_count, torch.rand(input_feature_count, output_feature_count),
...
if __name__ == '__main__':
    ...
    sa_simple = SelfAttention_Simple(3, 2, sa_linear.W_queries.weight.T, sa_linear.W_keys.weight.T,
